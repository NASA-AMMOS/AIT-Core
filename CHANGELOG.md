...
## [3.1.2](https://github.com/NASA-AMMOS/AIT-Core/compare/3.1.1...3.1.2)

### Merged

- Create makefile for ease developer set-up [`#563`](https://github.com/NASA-AMMOS/AIT-Core/pull/563)
- issue #531 - Add security note for ait-seq-send [`#561`](https://github.com/NASA-AMMOS/AIT-Core/pull/561)
- Issue #557 - Updating readthedocs.yml to use v2 syntax [`#558`](https://github.com/NASA-AMMOS/AIT-Core/pull/558)
- Issue #531 - Add Security notes to the server documentation [`#535`](https://github.com/NASA-AMMOS/AIT-Core/pull/535)

### Commits

- Merge commit from fork [`71fe87b`](https://github.com/NASA-AMMOS/AIT-Core/commit/71fe87bd6c4d2da6deec5fc5f630517a7f5cb508)
- GHSA-93gm-4cqq-j774: Sanitize tlmdict csv path to prevent traversal [`f5b4faa`](https://github.com/NASA-AMMOS/AIT-Core/commit/f5b4faa9888ec6e3246a302bb044e32b4f32e23b)
- Merge commit from fork [`4fcf4cc`](https://github.com/NASA-AMMOS/AIT-Core/commit/4fcf4cc2925f89cc7caf67527bc8ec43041cf1b2)
- Merge commit from fork [`ce973f0`](https://github.com/NASA-AMMOS/AIT-Core/commit/ce973f04d3d16f5a50327bccc8f379dec859d4fc)
- ghsa-7h55-xp8q-247v: Configurable bind address and improvements to websock unsub [`05b865b`](https://github.com/NASA-AMMOS/AIT-Core/commit/05b865b4c0672945b269b8d561518095ca836919)
- Creating Makefile and updating README to simplify setup [`02c727b`](https://github.com/NASA-AMMOS/AIT-Core/commit/02c727b3b845f2706c749de72b40d3b2c4e5a90a)
- ghsa-fjr5-6w4j-47xf: Check that file_name_pattern isn't supplied through REST API to avoid oom [`223e47d`](https://github.com/NASA-AMMOS/AIT-Core/commit/223e47dc3ce946a13498713021e19bf43118c132)
- ghsa-ccw5-g774-3683: Default to localhost and update security note on zeromq [`bfe360b`](https://github.com/NASA-AMMOS/AIT-Core/commit/bfe360b4c94b3fad22253f07dbe760d80dab5a03)
- Clean-up makefile equivalent [`691e976`](https://github.com/NASA-AMMOS/AIT-Core/commit/691e97649dcf039ecf2f914d698431882e28168b)
- Issue #531 - Removing note header [`c822a66`](https://github.com/NASA-AMMOS/AIT-Core/commit/c822a66c1a6c27eef08bb7cf964dce37f73564f6)
- Adding new lines for lint test [`7480524`](https://github.com/NASA-AMMOS/AIT-Core/commit/7480524234ce6194d8a19ea55a11f8931f75d3e7)
- Issue #557 - Updating readthedocs.yml [`667ed4a`](https://github.com/NASA-AMMOS/AIT-Core/commit/667ed4a8010eef9ad79023640a5b6e8c78a5ab54)

## [3.1.1](https://github.com/NASA-AMMOS/AIT-Core/compare/3.1.0...3.1.1) - 2026-05-19

### Commits

- Preparation for 3.1.1 release [`aa8ba17`](https://github.com/NASA-AMMOS/AIT-Core/commit/aa8ba17126da280348bf71dc1d4a8512c08b6c15)
- Merge commit from fork [`eddb3cd`](https://github.com/NASA-AMMOS/AIT-Core/commit/eddb3cddbbc4b0737385c8903bbb8c82e04b7437)
- Validate and clean log handler path + unit tests [`0261b70`](https://github.com/NASA-AMMOS/AIT-Core/commit/0261b70ce6f7af90b33dc6a1dfa98e9b103a4bbf)
- Catching error to throw 400 instead of 500 [`26482c8`](https://github.com/NASA-AMMOS/AIT-Core/commit/26482c89d36c02f6039b494ba0086872a9fbc7b9)
- Fixing bsc unit tests and error print return statement [`079ca81`](https://github.com/NASA-AMMOS/AIT-Core/commit/079ca81df09722966d115f07edd831471e34acf3)

## [3.1.0](https://github.com/NASA-AMMOS/AIT-Core/compare/3.0.0-rc1...3.1.0) - 2026-05-08

### Merged

- Issue-551: Updating readthedocs.yml python version [`#555`](https://github.com/NASA-AMMOS/AIT-Core/pull/555)
- issue-551: Restricting python version and removing pkg_resources [`#552`](https://github.com/NASA-AMMOS/AIT-Core/pull/552)
- Updated sarif report path value [`#548`](https://github.com/NASA-AMMOS/AIT-Core/pull/548)
- Create code-scanning.yml [`#546`](https://github.com/NASA-AMMOS/AIT-Core/pull/546)
- Adding sonar properties to project [`#547`](https://github.com/NASA-AMMOS/AIT-Core/pull/547)

### Commits

- Preparation for 3.1.0 release [`3122a7e`](https://github.com/NASA-AMMOS/AIT-Core/commit/3122a7e2de16b8097f03650bd82b9ec91f546e9f)
- Updating readthedocs.yml python version [`8b906a7`](https://github.com/NASA-AMMOS/AIT-Core/commit/8b906a7f8db68336d826c553c8ff8f94ad9e45e0)

## [3.0.0-rc1](https://github.com/NASA-AMMOS/AIT-Core/compare/2.5.2...3.0.0-rc1) - 2025-02-27

### Merged

- Issue #541 - Replace pickle with msgpack for 0MQ msg passing  [`#542`](https://github.com/NASA-AMMOS/AIT-Core/pull/542)
- Issue #536 - Remove pickle from config caching [`#537`](https://github.com/NASA-AMMOS/AIT-Core/pull/537)
- Issue #538 - Formatting and Linting [`#539`](https://github.com/NASA-AMMOS/AIT-Core/pull/539)
- Issue #530 - Use SafeLoader for YAML load calls [`#532`](https://github.com/NASA-AMMOS/AIT-Core/pull/532)
- Issue #518 - Update pre-commit config [`#519`](https://github.com/NASA-AMMOS/AIT-Core/pull/519)

### Commits

- Issue #543 - Update ait-seq-encode and ait-seq-decode which reference old method names [`35679f7`](https://github.com/NASA-AMMOS/AIT-Core/commit/35679f7fd7191be998f95aa797f591b89ec3976e)
- Remove match statement from Custom Types documentation [`69ad7fe`](https://github.com/NASA-AMMOS/AIT-Core/commit/69ad7fe3abfd497e6ad989b10aa40f84137d093e)

## [2.5.2](https://github.com/NASA-AMMOS/AIT-Core/compare/2.5.1...2.5.2) - 2024-01-30
