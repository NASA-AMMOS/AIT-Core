...
from ait.core.server.stream import PortInputStream
...
class TestStream:
    ...
    test_data = [
        ...
        (
            "udp_server",
            {
                ...
                "pub_type": zmq.green.core._Socket,
                "repr": "<PortInputStream name=some_udp_stream>",
            },
        ),
        (
            "tcp_server",
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (PortInputStream, invalid_stream_args),
    ...
    @pytest.mark.parametrize(
        "args,expected",
        [
            (["TCP", "127.0.0.1", 1234], TCPInputClientStream),
            (["TCP", "server", 1234], TCPInputServerStream),
            ([1234], PortInputStream),
            (["UDP", "server", 1234], PortInputStream),
            (["FOO"], ZMQStream),
        ],
    )
    def test_valid_stream_factory(self, args, expected):
        full_args = [
            "foo",
            args,
            [PacketHandler(input_type=int, output_type=str, packet="CCSDS_HEADER")],
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (["UDP", "127.0.0.1", "1234"], NotImplementedError),
    ...
    def test_invalid_stream_factory(self, args, expected):
        full_args = [
            "foo",
            args,
            [PacketHandler(input_type=int, output_type=str, packet="CCSDS_HEADER")],
