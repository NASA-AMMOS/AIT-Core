...
class SysLogParserTestSuccess(SysLogParserTest, unittest.TestCase):
    ...
    message  = ('<14>1 2015-03-06T21:29:43.756496Z LMC-037512 bliss 12074 '
               'INFO - Waiting for BLISS telemetry on port 2514')
    expected = {
        'pri'      : '14',
        'version'  : '1',
        ...
        'procid'   : '12074',
        'msgid'    : 'INFO',
        'msg'      : 'Waiting for BLISS telemetry on port 2514'
    }
...
class SysLogParserTestMsgWithHyphen(SysLogParserTest, unittest.TestCase):
    """Unit test of the log.SysLogParser.parse method"""
    message  = ('<14>1 2015-03-06T21:29:43.756496Z LMC-037512 bliss 12074 '
                'INFO - Waiting for BLISS - GUI telemetry')
    expected = {
        'pri'      : '14',
        'version'  : '1',
        'timestamp': '2015-03-06T21:29:43.756496Z',
        ...
        'procid'   : '12074',
        'msgid'    : 'INFO',
        'msg'      : 'Waiting for BLISS - GUI telemetry'
    }
